...
It can be useful to track how the average price of a product changes over time.  Let's now search for bovril products at all South African retailers.
...
Now, let's retrieve the price histories for each of these products, interpolate any missing prices and find the daily average for Bovril 250g at South African retailers.
